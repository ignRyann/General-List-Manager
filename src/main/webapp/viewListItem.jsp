                        ...
                        <tr>
                            ...
                            <td>
                                <form action="setItemLink.html" method="post">
                                    <input type="hidden" name="listName" value="<%=listName%>">
                                    <input type="hidden" name="itemName" value="<%=itemName%>">
                                    <button type="submit" class="btn btn-danger" name="itemLinkedList" value="">Reset</button>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="setItemText.html" method="post">
                                    <input type="hidden" name="listName" value="<%=listName%>">
                                    <input type="hidden" name="itemName" value="<%=itemName%>">
                                    <button type="submit" class="btn btn-danger" name="itemText" value="">Clear</button>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="setItemURL.html" method="post">
                                    <input type="hidden" name="listName" value="<%=listName%>">
                                    <input type="hidden" name="itemName" value="<%=itemName%>">
                                    <button type="submit" class="btn btn-danger" name="itemURL" value="">Clear</button>
                                </form>
                            </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <form action="deleteItemFile.html" method="get" enctype="multipart/form-data">
                                    <input type="hidden" name="listName" value="<%=listName%>">
                                    <button type="submit" class="btn btn-danger" name="itemName" value="<%=itemName%>">Clear</button>
                                </form>
                            </td>
                        </tr>
